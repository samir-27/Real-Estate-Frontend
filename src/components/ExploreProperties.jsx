...
const ExploreProperties = () => {
    ...
    return (
        <div className=' mx-auto container pt-10'>
            ...
            <h1 className='text-4xl font-bold'>Explore Property</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-10">
                ...
                {properties.slice(0, 6).map((property) => (
                    <div key={property.id} onClick={() => navigate(`/properties/${property._id}`)}
                    className="bg-white shadow-lg rounded-2xl overflow-hidden transition-transform transform hover:scale-105 cursor-pointer hover:shadow-xl">
